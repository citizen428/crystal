...
describe IO do
  ...
  describe "read operations" do
    ...
    it "does gets with big line" do
      big_line = "a" * 20_000
      io = SimpleIO::Memory.new("#{big_line}\nworld\n")
      io.gets.should eq("#{big_line}\n")
    end

    it "does gets with char delimiter" do
      io = SimpleIO::Memory.new("hello world")
    ...
    it "reads all remaining content" do
      io = SimpleIO::Memory.new("foo\nbar\nbaz\n")
      io.gets.should eq("foo\n")
      io.gets_to_end.should eq("bar\nbaz\n")
    end

    it "reads char" do
      io = SimpleIO::Memory.new("hi 世界")
  ...
  describe "encoding" do
    describe "decode" do
      it "gets_to_end" do
        str = "Hello world" * 200
        io = SimpleIO::Memory.new(str.encode("UCS-2LE"))
      ...
      it "raises on incomplete byte sequence" do
        io = SimpleIO::Memory.new("好".byte_slice(0, 1))
        io.set_encoding("GB2312")
      ...
      it "says invalid byte sequence" do
        io = SimpleIO::Memory.new(Slice.new(1, 140_u8))
        io.set_encoding("GB2312")
      ...
      it "does skips when converting to UTF-8" do
        io = SimpleIO::Memory.new(Base64.decode_string("ey8qx+Tl8fwg7+Dw4Ozl8vD7IOLo5+jy4CovfQ=="))
    ...
    describe "#encoding" do
      it "returns \"UTF-8\" if the encoding is not manually set" do
        SimpleIO::Memory.new.encoding.should eq("UTF-8")
      end
